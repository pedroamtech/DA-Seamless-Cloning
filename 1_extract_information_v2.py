...
def extract_information_vx(batch_size=2):
    ...
    for i in range(0, len(image_files), batch_size):
        ...
        for j, img_path in enumerate(batch_files):
            ...
            # El eje Z de la cámara en el mundo es la 3ra columna de R
            optical_axis_world = R[:, 2]
            # pitch = arcsin(z) -> -1 es nadir (abajo), 0 es horizonte
            # Usamos el signo negativo para que mirar hacia abajo sea ángulo negativo (estándar en muchos sistemas)
